        ...
        <div class="head">
            ...
            <div class="subtitle">
                ...
                <div class="dark_light">
                    <input type="checkbox" checked onchange="window.location.href='reviews_post_happy.php'">
                </div>
            </div>
        </div>
        <div class="sort">
            ...
            <div class="table_data" data-status="pending" style="display: none;">
                <?php
                    $pending_sql = "SELECT c.*, s.student_name
                                ...
                                JOIN admin a 
                                ON a.school_id = sc.school_id
                                WHERE c.mode = 'sad' AND c.confession_status = 'pending' AND a.admin_id = ?
                                ORDER BY c.confession_date_time DESC";
            ...
            <div class="table_data" data-status="approved" style="display: none;">
                <?php
                    $approved_sql = "SELECT c.*, s.student_name
                                ...
                                JOIN admin a 
                                ON a.school_id = sc.school_id
                                WHERE c.mode = 'sad' AND c.confession_status = 'approved' AND a.admin_id = ?
                                ORDER BY c.confession_date_time DESC";
            ...
            <div class="table_data" data-status="rejected" style="display: none;">
                <?php
                    $rejected_sql = "SELECT c.*, s.student_name
                                ...
                                JOIN admin a 
                                ON a.school_id = sc.school_id
                                WHERE c.mode = 'sad' AND c.confession_status = 'rejected' AND a.admin_id = ?
                                ORDER BY c.confession_date_time DESC";
