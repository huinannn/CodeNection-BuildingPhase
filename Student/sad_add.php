    ...
    <div class="confessions" style="padding-bottom: 0 !important;">
        <div class="header">
            <div class="header_left">
                <img src="../image/icons/close_white.png" alt="" onclick="window.location.href='sad_profile.php'">
            </div>
        ...
        <div class="content" style="margin-top: 70px; display: block;">
            <div class="post">
                <form id="postForm" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="mode" id="postMode" value="sad">
                </form>
            </div>
        </div>
        <div class="attach">
            ...
            <div class="small">
                ...
                <div class="each_attach">
                    <img class="more" src="../image/icons/more_white.png" alt="" onclick="changeToBig()">
                </div>
            </div>
            <div id="toast"></div>
        </div>
        ...
        postBtn.addEventListener("click", (e) => {
            ...
            .then(data => {
                if (data.status === "success") {
                    ...
                    postBtn.classList.remove("active");
                    setTimeout(() => window.location.href="sad_profile.php", 1500);
                } else {
